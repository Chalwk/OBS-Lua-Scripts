...
local function update_mic_mute()
    ...
    if mic_source == nil then return end
...
function script_description()
    return [[
Mutes "MIC/AUX" while any splash screen ("Starting Soon",
"Be Right Back", or "Stream Ended") is visible inside the
"Splash Screens" folder of the GAMING scene.
]]
end
